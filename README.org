* The Noctua (Editor + Barista + Minerva) Stack
  ...
  The current alpha instance is available at: http://noctua.berkeleybop.org - for a toy example model,
  see [[http://noctua.berkeleybop.org/seed/model/gomodel:55ad81df00000001][the scratch model]]
