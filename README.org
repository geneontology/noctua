* The Noctua/Barista/Minerva Stack (GO MME)
  
  More docs/API to be found [[http://kltm.github.io/go-mme][here]].
...
*** Running Minerva
    ...
    script, found in the OWLTools checkout(in the bin folder of
    owltools/MolecularModelServer). The only input parameter is the
    root directory for the local GO-SVN checkout.
